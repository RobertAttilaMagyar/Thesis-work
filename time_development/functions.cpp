                      ...
                      int **editcount_matrix, int num_editors, int num_articles, int T, bool activ)
{
    ...
    for (auto x = 0; x < T; ++x)
    {
        ...
        /*
        if (x == 25 || x == 50 || x == 100 || x == 200 || x == 500 || x == 1000)
        {
            std::string name;
            if (activ)
                name = "timedev_powerlaw_ne" + to_string(num_editors) + "_na" + to_string(num_articles) +
                       "_aE" + to_string(editors[0].ALPHA_E) + "_aA" + to_string(articles[0].ALPHA_A) + "_T" + to_string(x) + "_a1_m" + "1.csv";

            else
                name = "timedev_powerlaw_ne" + to_string(num_editors) + "_na" + to_string(num_articles) +
                       "_aE" + to_string(editors[0].ALPHA_E) + "_aA" + to_string(articles[0].ALPHA_A) + "_T" + to_string(x) + "_a0_m" + "1.csv";
        ...
        */
        ...
        std::string name;
        if (activ)
            name = "numedits_powerlaw_ne" + to_string(num_editors) + "_na" + to_string(num_articles) +
                   "_aE" + to_string(editors[0].ALPHA_E) + "_aA" + to_string(articles[0].ALPHA_A) + "_T" + to_string(5000) + "_a1_m" + "1.dat";

        else
            name = "numedits_powerlaw_ne" + to_string(num_editors) + "_na" + to_string(num_articles) +
                   "_aE" + to_string(editors[0].ALPHA_E) + "_aA" + to_string(articles[0].ALPHA_A) + "_T" + to_string(5000) + "_a0_m" + "1.dat";
