...
int main(int argc, char **argv)
{
    ...
    float pE = atof(argv[3]);
    float pA = atof(argv[4]);
    ...
    SIMULATION(false, num_editors, num_articles, pE, pA, dimensions, T);

    // simulation with the activity property
    SIMULATION(true, num_editors, num_articles, pE, pA, dimensions, T);
